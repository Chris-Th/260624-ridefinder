...
<x-ride.card.skeletton rootclass="py-1" class="text-start! place-content-start! grid grid-flow-row grid-cols-subgrid grid-rows-subgrid uppercase">
   ...
   {{--  <div class="row-span-1 col-span-4 underline decoration-dashed ">{{ $ride->rideType->name }}</div> --}}
    ...
    <div class="row-span-1 col-span-6 flex justify-between items-start h-full -translate-y-1">
        <div class="shadow-white/20 shadow-firm-sm-inner bg-white/5 flex h-full items-center size-fit border-2-white/80 border-dotted border rounded-full aspect-1">
        ...
        <div class="shadow-white/20 shadow-firm-sm-inner bg-white/5 flex h-full items-center border-2-white/80 border-dotted border rounded-full size-6 aspect-1">
        ...
        <div class="row-span-3 col-span-4  flex items-end text-lg italic">
            {{ $ride->rideType->name }}
        </div>
           {{-- <div class="row-span-1 col-span-4"></div> --}}
        {{-- src="{{ Storage::url('public/ridetypeimages/paceline-drawn-white-transparent.png') }}" --}}

    <div class="col-span-6 row-span-3 flex items-center justify-center border border-dashed border-gray-600 text-xs text-gray-400 ">
