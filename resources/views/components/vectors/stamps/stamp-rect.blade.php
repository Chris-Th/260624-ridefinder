...
>
  ...
  >
    ...
    <path
      x-bind:d="generateJitteredRect(w, h)"
      stroke-width="3.5"
    ...
    <path
      x-bind:d="generateJitteredRect(w - 12, h - 12)"
      stroke-width="1.2"
      stroke-linejoin="round"
    />
    ...
    <text
      x-bind:x="centerX"
      x-bind:y="padding + (h * 0.28)"
      x-bind:font-size="fontSize"
      font-weight="bold"
      fill="currentColor"
      stroke="none"
      text-anchor="middle"
